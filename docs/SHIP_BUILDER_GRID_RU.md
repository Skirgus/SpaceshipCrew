...
|-----|-------------|------------------|
| X, Y | 800 | `ShipBuilderGrid::PanelUnitXY` |
| Z (этаж) | 400 | `ShipBuilderGrid::PanelUnitZ` |
...
| **`Size`** | Габарит bbox в см, **производное** от `CellSize`: `Size = CellSize × (600, 600, 400)`. Только для чтения в Details. |
...
CornerWorld = GridPos × (600, 600, 400)   // по осям XY и Z
```
